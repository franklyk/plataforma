...
if(empty($PostFilters['client_digit'])){
    $message = [
...
$values = [$PostFilters['client_name'], $PostFilters['client_rz'], $PostFilters['client_email'], $PostFilters['client_phone'], $PostFilters['client_zipcode'],
    $PostFilters['client_address'], $PostFilters['client_number'], $PostFilters['client_complement'], $PostFilters['client_neighborhood'],
    ...
    $PostFilters['client_code2'], $PostFilters['client_agency2'], $PostFilters['client_account2'], $PostFilters['client_digit2'], $PostFilters['client_id']];
$params = ['client_name', 'client_rz', 'client_email', 'client_phone', 'client_zipcode', 'client_street', 'client_number', 'client_complement',
    'client_neighborhood', 'client_city', 'client_state', 'client_cpf', 'client_bank', 'client_code', 'client_agency', 'client_account',
    'client_digit', 'client_bank2', 'client_code2', 'client_agency2', 'client_account2', 'client_digit2', 'client_guid'];
$conditions = 'client_guid = :client_guid';
$Update -> Query('clients', $params, $values, $conditions);

$message = ['status'=> 'success', 'message' => "Dados do cliente atualizado com sucesso!", 'redirect'=> 'clients'];
echo json_encode($message);
return;