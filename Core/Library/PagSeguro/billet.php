...
$ValueTotal = $DevClass->FormatUSD($total + $Show['order_shipping_value'] - $Calc_Coupom);
$message = null;
...
$_SESSION['card'] =  '';
$_SESSION['billet'] =  $json->paymentLink;
$_SESSION['installments'] =  1;
$_SESSION['installmentsValue'] =  $ValueTotal;

$message = ["message" => "Seu boleto está disponível, vamos direcionar você!", "status" => "success", "redirect" => 'thanks'];
