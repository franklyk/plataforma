...
<body>
    <div class="container_top_info">
        <div class="bgcolor-white-light radius color-orange">
            <p class="font-text-extra ">
                <i class="fa fa-truck font-text-max "></i>
            <p class="text-center font-text-medium font-weight-medium color-orange">Frete Gratuito</p>
            <p class="text-center font-text-medium color-orange">Compras a partir de R$200,00</p>
        </div>
        <div class="bgcolor-white-light color-blue radius">
            <p class="text-center font-text-extra">
                    <i class="fa fa-credit-card font-text-max"></i>
            </p>
            <p class="text-center font-text-medium font-weight-medium">Pagamento no Cartão</p>
            <p class="text-center font-text-medium ">Pague no Cartão de Crédito em até 12x</p>
        </div>
        <div class="bgcolor-white-light color-red radius">
            <p class="text-center font-text-medium">
                    <i class="fa fa-gift font-text-max "></i>
            </p>
            <p class="text-center font-text-medium font-weight-medium">Ganhe Descontos nas Suas Próximas Compras</p>
        </div>
        <div class="bgcolor-white-light color-green radius">
            <p class="text-center font-text-medium">
                <i class="fa fa-phone font-text-max "></i>
            </p>
            <p class="text-center font-text-medium font-weight-medium">
                <span class="none"></span>Central de Atendimento
            </p>
            <p class="text-center font-text-medium ">Todos os Dias 24h/dia</p>
        </div>
    </div>
